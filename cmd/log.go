...
You can filter the log by time periods (today, week, month) or view statistics.`,
	Run: func(cmd *cobra.Command, args []string) {
		// This is a simplified version of the logic in core.HandleLog
		// It primarily exists to call the core logic with the correct flags
		// In a larger refactor, the parsing logic could be moved here entirely.
		core.HandleLog()
	},
}
